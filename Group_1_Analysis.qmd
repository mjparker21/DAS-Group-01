...
Through the comparison of multiple logistic regression models, we find that the following model minimises the AIC:
...
From our model we can draw multiple conclusions. Firstly, ...
