...
Finally, to see if our model predicts as we would expect it to, we produce plots of the probability of an individual self-evaluating as obese by the various lifestyle and socio-conomic factors. These plots are displayed in @fig-probs1 . From the plots it is clear that the probabilities of an individual being obese vary by these factors and, in fact, these probabilities match our analysis in @sec-exploranalysis.
