...
+0.375\cdot\mathbb{I}_\text{Looking after home/family}+ 0.248\cdot\mathbb{I}_\text{Looking for/Intending to look for work} \\

+0.443\cdot\mathbb{I}_\text{Perm unable to work} + 0.049\cdot\mathbb{I}_\text{Retired} +0.308\cdot\mathbb{I}_\text{25-34} \\

+0.511\cdot\mathbb{I}_\text{35-44} +0.632\cdot\mathbb{I}_\text{45-54} + 0.618\cdot\mathbb{I}_\text{55-64} + 0.775\cdot\mathbb{I}_\text{65-74} \\ 

+0.562\cdot\mathbb{I}_\text{75+}+ 0.312\cdot\mathbb{I}_\text{Male and 25-34} + 0.348\cdot\mathbb{I}_\text{Male and 35-44} \\

+ 0.500\cdot\mathbb{I}_\text{Male and 45-54} + 0.723\cdot\mathbb{I}_\text{Male and 55-64}
+ 0.571\cdot\mathbb{I}_\text{Male and 65-74} + 0.237\cdot\mathbb{I}_\text{Male and 75+} \\
